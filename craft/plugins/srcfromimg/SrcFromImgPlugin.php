...
class SrcFromImgPlugin extends BasePlugin
{
    /**
    ...
    {
        return Craft::t('Returns the src attribute from a full &lt;img&gt; tag');
    }
    ...
    {
        return 'https://github.com/chrisrowe/srcfromimg/blob/master/README.md';
    }
    ...
    {
        return 'https://raw.githubusercontent.com/chrisrowe/srcfromimg/master/releases.json';
    }
    ...
    {
        Craft::import('plugins.srcfromimg.twigextensions.SrcFromImgTwigExtension');

        return new SrcFromImgTwigExtension();
    }
